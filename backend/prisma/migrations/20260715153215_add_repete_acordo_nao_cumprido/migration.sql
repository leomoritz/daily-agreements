...
CREATE TABLE "new_Task" (
    ...
    "repeteAcordoNaoCumprido" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Task" ("acordoAtualId", "concluida", "criadaEm", "descricao", "id", "numTentativas", "ordemExibicao", "responsavelId", "tentativasAvaliarPlanejar", "titulo") SELECT "acordoAtualId", "concluida", "criadaEm", "descricao", "id", "numTentativas", "ordemExibicao", "responsavelId", "tentativasAvaliarPlanejar", "titulo" FROM "Task";
DROP TABLE "Task";
